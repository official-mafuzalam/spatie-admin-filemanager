...
<body class="bg-gray-50 dark:bg-slate-900">
    ...
    <div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
        ...
        <header>
            ...
            <h1 class="block text-2xl font-bold text-gray-800 sm:text-3xl dark:text-white">Application Layout: Sidebar
                & Header using Tailwind CSS</h1>
            <p class="mt-2 text-lg text-gray-800 dark:text-gray-400">This is a simple application layout with sidebar
                and header examples using Tailwind CSS.</p>
